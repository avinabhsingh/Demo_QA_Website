import textbox from "../../pageobjects_Avi/DemoQA/Elements/Textbox"
import checkbox from "../../pageobjects_Avi/DemoQA/Elements/Checkbox";
import radiobutton from "../../pageobjects_Avi/DemoQA/Elements/Radiobutton";
import webtables from "../../pageobjects_Avi/DemoQA/Elements/Webtables";
import button from "../../pageobjects_Avi/DemoQA/Elements/Button";
import links from "../../pageobjects_Avi/DemoQA/Elements/Links";
import broken from "../../pageobjects_Avi/DemoQA/Elements/Broken_Img&Links";
import up_down from "../../pageobjects_Avi/DemoQA/Elements/Up_Down";
import dynamic from "../../pageobjects_Avi/DemoQA/Elements/Dynamic";
import practice_form from "../../pageobjects_Avi/DemoQA/Form/Practice_form";
import browserwindows from "../../pageobjects_Avi/DemoQA/Alerts_Frames_Windows/BrowserWindows";
import alert from "../../pageobjects_Avi/DemoQA/Alerts_Frames_Windows/Alerts";
import frame from "../../pageobjects_Avi/DemoQA/Alerts_Frames_Windows/Frames";
import nested_frames from "../../pageobjects_Avi/DemoQA/Alerts_Frames_Windows/Nested_frames";
import modal_dialogs from "../../pageobjects_Avi/DemoQA/Alerts_Frames_Windows/Modal_Dialogs";
import accordian from "../../pageobjects_Avi/DemoQA/Widgets/Accordian";
import autocomplete from "../../pageobjects_Avi/DemoQA/Widgets/Auto_Complete";
import datepicker from "../../pageobjects_Avi/DemoQA/Widgets/DatePicker";
import slider from "../../pageobjects_Avi/DemoQA/Widgets/Slider";
import progressbar from "../../pageobjects_Avi/DemoQA/Widgets/Progress_Bar";
import tab from "../../pageobjects_Avi/DemoQA/Widgets/Tabs";
import tooltips from "../../pageobjects_Avi/DemoQA/Widgets/Tool_Tips";
import menu from "../../pageobjects_Avi/DemoQA/Widgets/Menu";
import selectmenu from "../../pageobjects_Avi/DemoQA/Widgets/Select_Menu";
import sortable from "../../pageobjects_Avi/DemoQA/Interactions/Sortable";
import selectable from "../../pageobjects_Avi/DemoQA/Interactions/Selectable";
import resize from "../../pageobjects_Avi/DemoQA/Interactions/Resizable";
import dropp from "../../pageobjects_Avi/DemoQA/Interactions/Droppable";
import dragg from "../../pageobjects_Avi/DemoQA/Interactions/Dragabble";
import login from "../../pageobjects_Avi/DemoQA/Book Store Application/Login";
import register from "../../pageobjects_Avi/DemoQA/Book Store Application/Register";
import profile from "../../pageobjects_Avi/DemoQA/Book Store Application/Profile";
...
describe('DemoQA -> Text Box', () => {
    ...
    it('TC - 01 Verify Textbox UI', () => {
        ...
        textbox.elements.permanent_add_label().should('have.text', 'Permanent Address');
    })
...
describe('DemoQA -> Web Tables', () => {
    ...
    it('TC - 01 Verify Web Tables UI', () => {
        ...
        const column_names = ['First Name', 'Last Name', 'Age', 'Email', 'Salary', 'Department', 'Action'];
    ...
    it('TC - 02 Verify adding records in a table', () => {
        ...
        const label_names = ['First Name', 'Last Name', 'Email', 'Age', 'Salary', 'Department'];
        ...
        webtables.elements.form_fields().each(($element, index) => {
            ...
            cy.wrap($element).should('have.text', label_names[index] || 'Test case failed');
        });
    ...
    it('TC - 04 Verify adding values after validation', function () {
        ...
        webtables.elements.firstname().type('Avinabh');
        webtables.elements.firstname().should('have.attr', 'value').and('not.be.empty');

        //Type & Check lastname field is filled
        webtables.elements.lastname().should('have.attr', 'value', '');
        webtables.elements.lastname().type('Singh');
        webtables.elements.lastname().should('have.attr', 'value').and('not.be.empty');
        ...
        webtables.elements.salary().should('have.attr', 'value').and('not.be.empty');
    ...
    it('TC - 05 Verify validation for firstname', function () {
        ...
        webtables.elements.firstname().type('ASKNDASDAJSDKJAKSDJ').invoke('attr', 'maxlength').then((maxlength) => {
            //Pass the retrieved value of maxlength from input to value variable
            webtables.elements.firstname().invoke('val').then((value) => {
                const inputValueLength = value.length; // Get the length of the input value
                if (inputValueLength <= parseInt(maxlength)) { //parseInt() is commonly used to convert Strings to Integers
                    cy.log('Test case passed - Value length is less than or equal to maxlength');
                }
                else {
    ...
    it('TC - 06 Verify Email RegEX', function () {
        ...
        webtables.elements.email().invoke('val').then(email => {
    ...
    it('TC - 07 Verify Salary RegEX', function () {
        ...
        webtables.elements.salary().invoke('val').then(salary => {
            if (!salary.match(/^\d*$/)) {
    ...
    it('TC - 08 Verify Age RegEX', function () {
        ...
        webtables.elements.age().invoke('val').then(age => {
            if (!age.match(/^\d*$/)) {
                cy.fail('Invalid age');
            }
        });
    ...
    it('TC - 09 Verify searchbar functionality', function () {
        ...
        webtables.elements.table_rows().eq(0).invoke('text').then((text) => {
            if (text.trim() == '') {
...
describe('DemoQA -> Links', () => {
    ...
    it('TC - 03 API call for "Created" link -- 201', () => {
        ...
        cy.wait('@api_response_details', { timeout: 10000 }).then((interception) => {
    ...
    it('TC - 05 API call for "Moved" link -- 301', () => {
        ...
        cy.wait('@api_response_details', { timeout: 10000 }).then((interception) => {
            ...
            expect(interception.response.statusMessage).to.equal('Moved Permanently');
            expect(interception.request.method).to.equal('GET');
        });
    })
...
describe('DemoQA -> Broken Links & Images', () => {
    ...
    it('TC - 02 Verify valid Image', () => {
        ...
        broken.elements.valid_img().should('be.visible').and('have.prop', 'naturalWidth').should('be.greaterThan', 0)
    })

    it('TC - 03 Verify broken Image', () => {
        //Assertion for broken image
        broken.elements.broken_img().should('be.visible').and('have.prop', 'naturalWidth').should('be.equal', 0)
    })
})
...
describe('Tools QA -> Upload and Download', () => {
    ...
    it('TC - 03 Verify Upload functionality', () => {
        ...
        //Upload a valid file
        up_down.elements.upload_btn().selectFile('C:/Users/avinabh.s/Pictures/img.jpg');
...
describe('Demo QA -> Dynamic Properties', () => {
    ...
    beforeEach(() => {
        ...
        //Assertion to check header label
        textbox.elements.header_label().should('be.visible').and('contain', 'Dynamic Properties');
    })
    ...
    it('TC - 02 Changes text color after 5 seconds wait', () => {
        ...
        dynamic.elements.color_change().should('have.css', 'color', 'rgb(220, 53, 69)');
    });
...
describe('Demo QA -> Forms', () => {
    ...
    it('TC - 01 Verify Practice Form UI', function () {
        ...
        //Assertion to check header label
        textbox.elements.header_label().should('be.visible').and('have.text', 'Practice Form');

        //Assertion on visiblity of all the labels
        practice_form.elements.name_label().should('be.visible').and('have.text', 'Name');
        practice_form.elements.email_label().should('be.visible').and('have.text', 'Email');
        practice_form.elements.gender_label().should('be.visible').and('contain', 'Gender');
        practice_form.elements.mobile_label().should('be.visible').and('contain', 'Mobile');
        practice_form.elements.dob_label().should('be.visible').and('have.text', 'Date of Birth');
        practice_form.elements.subject_label().should('be.visible').and('have.text', 'Subjects');
        practice_form.elements.hobbies_label().should('be.visible').and('have.text', 'Hobbies');
        practice_form.elements.picture_label().should('be.visible').and('have.text', 'Picture');
        practice_form.elements.address_label().should('be.visible').and('have.text', 'Current Address');
        practice_form.elements.state_city_label().should('be.visible').and('have.text', 'State and City');
    ...
    it('TC - 02 Verify Practice Form Functionality', function () {
        ...
        practice_form.elements.result_table().within(() => {
            ...
            cy.contains('tr', 'Student Email').find('td').eq(1).should('contain', emailid);
            cy.contains('tr', 'Gender').find('td').eq(1).should('contain', 'Male');
            cy.contains('tr', 'Mobile').find('td').eq(1).should('contain', mobilenumber);
            cy.contains('tr', 'Date of Birth').find('td').eq(1).should('contain', day + ' ' + mon + ',' + yr);

            cy.contains('tr', 'Subjects').find('td').eq(1).should('contain', subjects[0])
...
describe('Demo QA -> Browser Windows', () => {
    ...
    it('TC - 02 Verify New Window Functionality', function () {
        ...
        cy.get('@newwincall').should('be.calledWith', Cypress.sinon.match('/sample'));
    })
...
describe('Demo QA -> Alerts', () => {
    ...
    it('TC - 02 Verify Alert after 5 second wait Functionality', function () {
        ...
        cy.get('@alertmsg').should('be.calledWith', 'This alert appeared after 5 seconds');
    })
    ...
    it('TC - 03 Verify OK button for Confirm Alert', function () {
        ...
        alert.elements.confirm_result().should('be.visible').and('have.text', 'You selected Ok');
    })
    ...
    it('TC - 04 Verify Cancel button for Confirm Alert', function () {
        ...
        alert.elements.confirm_result().should('be.visible').and('have.text', 'You selected Cancel');
    })
    ...
    it('TC - 05 Verify Prompt Alert Functionality', function () {
        ...
        alert.elements.prompt_result().should('be.visible').and('have.text', 'You entered Avinabh');
    })
})
...
describe('Demo QA -> Frames', () => {
    ...
    it('TC 01 - Verify Frames functionality', function () {
        ...
        frame.elements.frame1().should('have.attr', 'width', '500px')
            .and('have.attr', 'height', '350px');

        // Switch to the first iframe
        frame.elements.frame1().then((iframe1) => {
            cy.wrap(iframe1).should('have.prop', 'contentDocument').and('exist').then((Doc_Content) => {

                // Assert on the content inside the body of the iframe
                cy.wrap(Doc_Content).find('body').should('contain.text', 'This is a sample page');
            });
        })

        //Assert on width and height of second frame
        frame.elements.frame2().should('have.attr', 'width', '100px')
            .and('have.attr', 'height', '100px');


        //Switch to the second iframe
        frame.elements.frame2().then((iframe2) => {
            cy.wrap(iframe2).should('have.prop', 'contentDocument').and('exist').then((Doc_Content) => {
...
describe('Demo QA -> Nested Frames', () => {
    ...
    it('TC 01 - Verify Nested Frames functionality', function () {
        ...
        nested_frames.elements.parent_frame().should('contain.text', 'Parent frame');
        ...
        nested_frames.elements.parent_frame().find('iframe[srcdoc="<p>Child Iframe</p>"]').should('be.visible').then((cframe) => {
...
describe('Demo QA -> Modal Dialogs', () => {
    ...
    it('TC 01 - Verify Small Modal Dialog functionality', function () {
        ...
        modal_dialogs.elements.small_dialog_head().should('have.text', 'Small Modal');

        // Assertion to check small dialog content
        modal_dialogs.elements.dialog_content().should('have.text', 'This is a small modal. It has very less content');
    ...
    it('TC 02 - Verify Large Modal Dialog functionality', function () {
        ...
        modal_dialogs.elements.large_dialog_head().should('have.text', 'Large Modal');
...
describe('Demo QA -> Accordian', () => {
    ...
    it('TC 01 - Verify first Accordian functionality', function () {
        ...
        accordian.elements.section1_head().should('be.visible').and('have.text', 'What is Lorem Ipsum?');
        accordian.elements.section1_body().should('be.visible').and('contain', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry');
    })
    ...
    it('TC 02 - Verify second Accordian functionality', function () {
        ...
        accordian.elements.section2_head().should('be.visible').and('have.text', 'Where does it come from?');
        accordian.elements.section2_body().should('be.visible').and('contain', 'Contrary to popular belief, Lorem Ipsum is not simply random text.');
    })
    ...
    it('TC 03 - Verify third Accordian functionality', function () {
        ...
        //Assertion to check second section
        accordian.elements.section3_head().should('be.visible').and('have.text', 'Why do we use it?');
        accordian.elements.section3_body().should('be.visible').and('contain', '(injected humour and the like).');
    })
})
...
describe('Demo QA -> Auto Complete', () => {
    ...
    it('TC 01 - Enter multiple Colors using autocomplete', function () {
        ...
        autocomplete.elements.multiple().should('contain', 'Type multiple color names')
    ...
    it('TC 03 - Enter single color', function () {
        ...
        //Assert to check single color label
        autocomplete.elements.suggestions().contains('Magenta').should('exist').type('{enter}');
        ...
        //Assert to check single color label
        autocomplete.elements.suggestions().contains('Black').should('exist').type('{enter}');
...
describe('Demo QA -> Date Picker', () => {
    ...
    it('TC 02 - Verify Date and Time Functionality', function () {
        ...
        datepicker.elements.dateandtime().should('have.value', 'October 18, 2015 4:45 AM')
    })
})
...
describe('Demo QA -> Slider', () => {
    ...
    it('TC 01 - Verify Slider Functionality', function () {
        ...
        slider.elements.range_slider().invoke('val').then(value => {
...
describe('Demo QA -> Progress Bar', () => {
    ...
    it('TC 02 - Verify Progress Bar Functionality', function () {
        ...
        let initialText;
        progressbar.elements.bar().invoke('text').then(text => {
            initialText = text;
    ...
    it('TC 03 - Verify Reset Progress Bar Functionality', function () {
        ...
        progressbar.elements.reset_btn().should('be.visible').and('have.text', 'Reset');
...
describe('Demo QA -> Tool Tips', () => {
    ...
    it('TC 02 - Verify Tool Tip function for button', function () {
        ...
        tooltips.elements.tooltip_result().should('be.visible').and('have.text','You hovered over the Button');
    })
    ...
    it('TC 03 - Verify Tool Tip function for textfield', function () {
        ...
        tooltips.elements.tooltip_result().should('be.visible').and('have.text','You hovered over the text field');
    }) 
  
    it('TC 04 - Verify Tool Tip function for text', function () {
        
        //Hover mouse over the first link in text
        tooltips.elements.tip_text().find('a[href]').eq(0).trigger('mouseover').invoke('show');
        
        //Assert tooltip is visible for first link in text
        tooltips.elements.tooltip_result().should('be.visible').and('have.text','You hovered over the Contrary');

        //Hover mouse over the second link in text
        tooltips.elements.tip_text().find('a[href]').eq(1).trigger('mouseover').invoke('show');
        
        //Assert tooltip is visible for second link in text
        //contain is only used because both tooltips are visible together
        tooltips.elements.tooltip_result().should('be.visible').and('contain.text','You hovered over the 1.10.32');
    })
})
...
describe('Demo QA -> Select Menu', () => {
    ...
    beforeEach(function () {
        ...
        it('TC 01 - Verify Select Menu UI', function () {
            ...
            selectmenu.elements.entire_menu().should('contain', 'Select Value')
        ...
        it('TC 02 - Verify Select Value dropdown functionality', function () {
            ...
            selectmenu.elements.group_opt().invoke('css', 'overflow', 'visible').click();
            ...
            selectmenu.elements.dropdown_group1().should('be.visible').and('contain', 'Group 1');
            selectmenu.elements.dropdown_group2().should('be.visible').and('contain.text', 'Group 2');
        ...
        it('TC 03 - Verify Select One dropdown functionality', function () {
            ...
            //Assert dropdown itself contains two groups
            selectmenu.elements.select_dropdown_heading().should('be.visible').and('contain', 'Pick one title');
    ...
    it('TC 06 - Verify Standard Multiselect functionality', function () {
        ...
        selectmenu.elements.standard_select().select(['Volvo', 'Saab', 'Audi'], { multiple: true });
    })
})
...
describe('Demo QA -> Sortable', () => {
    ...
    it('TC 02 - Verify Sortable List Functionality', function () {
        ...
        for (let i = 0; i < (numbers.length - 1); i++) {
            ...
            sortable.elements.sort_list().contains('Six').trigger('mousemove').trigger('mouseup'); //Mouse move and mouse up on the last element

            //Assert that the order of elements has been rearranged
            sortable.elements.list_num().eq(0).should('contain', numbers[i + 1]);
        }
    })
    ...
    it('TC 03 - Verify Sortable Grid Functionality', function () {
        ...
        for (let i = 0; i < (numbers.length - 1); i++) {
            //Drag the current element to the last position
            sortable.elements.sort_grid().contains(numbers[i]).trigger('mousedown', { which: 1 }); //Mouse down on the current element
            sortable.elements.sort_grid().contains('Nine').trigger('mousemove').trigger('mouseup'); //Mouse move and mouse up on the last element

            cy.wait(500);
            //Assert that the order of elements has been rearranged
            sortable.elements.list_num().eq(6).should('contain', numbers[i + 1]); //eq is set to 6 because it contains total 15 elements(including list & grid)
        }
    })
})
...
describe('Demo QA -> Selectable', () => {
    ...
    it('TC 02 - Verify Selectable List Functionality', function () {
        ...
        for (let i = 1; i <= 3; i++) {
            selectable.elements.options_list().eq(i).click().should('have.css', 'background-color', 'rgb(0, 123, 255)');
        }

        //Loop through again to deselect elements in list
        for (let i = 1; i <= 3; i++) {
            selectable.elements.options_list().eq(i).click().should('have.css', 'background-color', 'rgb(255, 255, 255)');
        }
    })
...
describe('Demo QA -> Resizable', () => {
    ...
    it('TC 02 - Verify restricted resizable functionality', function () {
        ...
        resize.elements.restrict_box().should('have.css', 'width', '200px').and('have.css', 'height', '200px');

        //Resize the element to its minimum width and height
        resize.elements.resize_cursor().eq(0)
            .trigger('mousedown', { which: 1 })
            .trigger('mousemove', { clientX: 0, clientY: 0 })
            .trigger('mouseup');

        //Assert to check width and height set to minimum
        resize.elements.restrict_box().should('have.css', 'width', '150px').and('have.css', 'height', '150px');
        ...
        //Assert to check width and height set to minimum
        resize.elements.restrict_box().should('have.css', 'width', '500px').and('have.css', 'height', '300px');
    })

    it('TC 03 - Verify unrestricted resizable functionality', function () {

        //Assert to check current width and height
        resize.elements.unrestricted_box().should('have.css', 'width', '200px').and('have.css', 'height', '200px');

        //Resize the element to any width and height
        resize.elements.resize_cursor().eq(1)
            .trigger('mousedown', { which: 1 })
            .trigger('mousemove', { clientX: 951, clientY: 1423 })
            .trigger('mouseup').then((values) => {
...
describe('Demo QA -> Droppable', () => {
    ...
    beforeEach(function () {
        ...
        it('TC 01 - Verify Droppable UI', function () {
            ...
            dropp.elements.prevent_tab().should('be.visible').and('contain', 'Prevent Propogation');
            dropp.elements.revert_tab().should('be.visible').and('contain', 'Revert Draggable');
    ...
    it('TC 02 - Verify Single droppable functionality', function () {
        ...
        dropp.elements.dropbox().eq(0).trigger('mousemove').trigger('mouseup', { force: true });

        cy.wait(2000);

        //Assert box is dropped into box and color is changed
        dropp.elements.dropbox().eq(0).should('have.text', 'Dropped!').and('have.css','background-color','rgb(70, 130, 180)');
    })
    ...
    it('TC 03 - Verify Acceptable box functionality', function () {
        ...
        dropp.elements.dropbox().eq(1).trigger('mousemove').trigger('mouseup', { force: true });

        //Assert box is dropped into box and color is changed
        dropp.elements.dropbox().eq(1).should('have.text', 'Dropped!').and('have.css','background-color','rgb(70, 130, 180)');
    })
    ...
    it('TC 04 - Verify not acceptable box functionality', function () {
        ...
        dropp.elements.dropbox().eq(1).should('not.have.text', 'Dropped!').and('not.have.css','background-color','rgb(70, 130, 180)');
    })
    ...
    it('TC 05 - Verify no greed prevent propogation functionality', function () {
        ...
        dropp.elements.nogreed_innerbox().trigger('mousemove').trigger('mouseup', { force: true });

        //Assert box is dropped in no greed(parent and inner both) dropbox and color & text is changed
        dropp.elements.nogreedbox().should('contain', 'Dropped!').and('have.css','background-color','rgb(70, 130, 180)');
        dropp.elements.nogreed_innerbox().should('have.text', 'Dropped!').and('have.css','background-color','rgb(70, 130, 180)');
    })
    ...
    it('TC 06 - Verify Revert Draggable functionality', function () {
        ...
        dropp.elements.revertbox().then(box => {
            ...
            dropp.elements.dropbox().eq(2).trigger('mousemove').trigger('mouseup', { force: true });

            cy.wait(1000);

            //Assert box is dropped in dropbox
            dropp.elements.dropbox().eq(2).should('have.text', 'Dropped!').and('have.css', 'background-color', 'rgb(70, 130, 180)');
...
describe('Demo QA -> Dragabble', () => {
    ...
    beforeEach(function () {
        ...
        it('TC 01 - Verify Dragabble UI', function () {
            ...
            dragg.elements.axis_restrict_tab().should('be.visible').and('have.text', 'Axis Restricted');
            dragg.elements.container_restrict_tab().should('be.visible').and('have.text', 'Container Restricted');
            dragg.elements.cursor_style_tab().should('be.visible').and('have.text', 'Cursor Style');
    ...
    it('TC 02 - Verify Simple Dragabble functionality', function () {
        ...
        dragg.elements.dragbox().then(initial => {
            ...
            dragg.elements.dragbox().move({ deltaX: left_move, deltaY: top_move, force: true })
    ...
    it('TC 03 - Verify X - Axis restricted Dragabble functionality', function () {
        ...
        dragg.elements.x_restrictbox().then(initial => {
            ...
            //Drag the dragabble element.
            dragg.elements.x_restrictbox().move({ deltaX: left_move, deltaY: top_move, force: true })
    ...
    it('TC 04 - Verify Y - Axis restricted Dragabble functionality', function () {
        ...
        dragg.elements.y_restrictbox().then(initial => {
            ...
            //Drag the dragabble element.
            dragg.elements.y_restrictbox().move({ deltaX: left_move, deltaY: top_move, force: true })
    ...
    it('TC 05 - Verify Container Restricted Dragabble functionality', function () {
        ...
        dragg.elements.parent_block().then(parent => {
            ...
            dragg.elements.dragbox_restrict().then(child => {
                ...
                dragg.elements.dragbox_restrict().move({ deltaX: 9999, deltaY: 9999, force: true })
    ...
    it('TC 06 - Verify Text Restricted Dragabble functionality', function () {
        ...
        dragg.elements.text_restrict_parent().then(parent => {
            ...
            dragg.elements.text_restrict().then(child => {
                ...
                dragg.elements.text_restrict().move({ deltaX: 9999, deltaY: 9999, force: true })
    ...
    it('TC 07 - Verify Cursor Style Dragabble functionality', function () {
        ...
        //Move the second box
        dragg.elements.topleft_cursor().move({ deltaX: 380, deltaY: -60, force: true }).then($element => {
        ...
        //Move the third box
        dragg.elements.bottom_cursor().move({ deltaX: 380, deltaY: 40, force: true }).then($element => {
            const cursorStyle = $element.css('cursor');
...
describe('Demo QA -> Book Store Application (Register)', () => {
    ...
    beforeEach(function () {
        ...
        login.elements.bookstore_label().scrollIntoView().should('be.visible').click();
    ...
    it('TC 01 - Verify Book Store Application Register Page UI', function () {
        ...
        register.elements.register_form().should('contain', 'Register to Book Store');

        //Assert that all labels are visible
        register.elements.firtname_label().should('be.visible').and('contain', 'First Name');
        register.elements.lastname_label().should('be.visible').and('contain', 'Last Name');
        register.elements.username_label().should('be.visible').and('contain', 'UserName');
        register.elements.password_label().should('be.visible').and('contain', 'Password');
    ...
    it('TC 04 - Verify validation message for already registered user', function () {
        ...
        register.elements.validationmsg().should('be.visible').and('have.text', 'User exists!');
    })
    ...
    it('TC 05 - Verify validation message for invalid input in password field', function () {
        ...
        //Assert validation message is displayed
        register.elements.validationmsg().should('be.visible').and('have.text', "Passwords must have at least one non alphanumeric character, one digit ('0'-'9'), one uppercase ('A'-'Z'), one lowercase ('a'-'z'), one special character and Password must be eight characters or longer.");
    })
    ...
    it('TC 06 - Verify validation message for blank input in captcha verification', function () {
        ...
        //Assert validation message is displayed
        register.elements.validationmsg().should('be.visible').and('have.text', "Please verify reCaptcha to register!");
    })
...
describe('Demo QA -> Book Store Application (Login)', () => {
    ...
    beforeEach(function () {
        ...
        it('TC 01 - Verify Book Store Application Login Page UI', function () {
            ...
            login.elements.username_label().should('be.visible').and('contain','UserName');
            login.elements.password_label().should('be.visible').and('contain','Password');
    ...
    it('TC 02 - Verify Book Store Application Login Functionality', function () {
        ...
        profile.elements.username_value().should('be.visible').and('have.text','Avi@1234');
    })
